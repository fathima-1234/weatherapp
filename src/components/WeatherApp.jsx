...
function WeatherApp() {
  ...
  return (
    <div className='bg-gradient-to-r from-blue-300 to-blue-400 w-full h-screen  flex flex-col justify-center items-center '>
      ...
      {values.city &&
        <div className='w-[20rem] md:w-[25rem] h-[30rem] bg-blue-500 rounded-lg'>
